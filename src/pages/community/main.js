...
submitPost.forEach((submittedPost) => {
  submittedPost.addEventListener("click", () => {
    ...
    postContainer.innerHTML = `<div class="mb-2">
            ...
            >
              <img src="/src/assets/communitypage-assets/chap.png" alt="chap" class="w-6 h-6" />
              <p class="flex-1 text-green-700">@chap</p>
              <img src="/src/assets/communitypage-assets/message.png" alt="message" class="w-4 h-4" />
              <img src="/src/assets/communitypage-assets/like.png" alt="like" class="w-4 h-4" />
            </div>
            <p
